...
export default function DangerZone({
  ...
  return (
    <div className="rounded-xl border border-red-100 bg-surface px-6 py-5 transition-colors dark:border-red-950 dark:bg-surface-dark">
      ...
      {!confirmDelete ? (
        ...
        <div className="flex items-center gap-3">
          <p className="text-sm text-ink-muted dark:text-ink-muted-dark">Tem certeza?</p>
          <button
            onClick={onDelete}
            disabled={deleting}
